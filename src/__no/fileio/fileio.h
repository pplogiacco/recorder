...
***************************************************************************/
typedef bool (*FILEIO_InternalFlash_WriteProtectStateGet)(void * mediaConfig);

// Function pointer table that describes a drive being configured by the user
typedef struct
{
    FILEIO_InternalFlash_IOInitialize funcIOInit;                          // I/O Initialization function
    FILEIO_InternalFlash_MediaDetect funcMediaDetect;                      // Media Detection function
    FILEIO_InternalFlash_MediaInitialize funcMediaInit;                    // Media Initialization function
    FILEIO_InternalFlash_MediaDeinitialize funcMediaDeinit;                // Media Deinitialization function.
    FILEIO_InternalFlash_SectorRead funcSectorRead;                        // Function to read a sector of the media.
    FILEIO_InternalFlash_SectorWrite funcSectorWrite;                      // Function to write a sector of the media.
    FILEIO_InternalFlash_WriteProtectStateGet funcWriteProtectGet;         // Function to determine if the media is write-protected.
} FILEIO_DRIVE_CONFIG;
