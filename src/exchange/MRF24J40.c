...
void MRF24J40_Enable(mrftype_t type, uint8_t channel, uint16_t macaddr, uint16_t panid) {
    ...
    // Perform a software Reset (RSTPWR=1,RSTBB=1, RSTMAC=1)
    MRF24J40_writeShort(MRF_SOFTRST, 0b00000111);
...
#else
    // Impostare qui PanID e MAC !!!!!!!!!!!!!
    MRF24J40_setPanId(panid);
    MRF24J40_setAddress(macaddr);
    ...
    MRF24J40_setChannel(channel); // Set default channel (must keep 11) and reset state machine

    // Set transmitter power - See REGISTER 2-62: RF CONTROL REGISTER (ADDRESS: 0x203)
    // MRF24J40_enablePaLna(); 
    switch (module_type) { // Special MRF24J40 setting for Microchip module
        case MRF24J40MA: // No Pa/LNA control
            ...
            //        case MRF24J40MB: // GPIO1 and GPIO2 are connected
            ...
            //            break;
            //
            //        case MRF24J40MC: // GPIO1, GPIO2 and GPIO3 are connected 
            //            // GPIO3 enables (high) or disables (low) the PA voltage regulator
        ...
        case MRF24J40MD: // MRF24J40MD/ME RF Transceiver Module with PA/LNA
...
void MRF24J40_Disable() {
    ...
    switch (module_type) {
        case MRF24J40MA:
            ...
            //        case MRF24J40MB: // GPIO1 and GPIO2 are connected
            //        case MRF24J40MC: // GPIO1, GPIO2 and GPIO3 are connected 
        case MRF24J40MD: // MRF24J40MD/ME: GPIO1, GPIO2 and GPIO3 are connected
